...
This is the Google Schemer cloned application for praticing my first web programming
[*the Google Schemer cloned application: Learn Web Development with Rails*](http://www.huing.com/)
by [Daniel Wang](http://www.huing.com/). You can use this reference implementation to help track down errors if you end up having trouble with code in the tutorial. In particular, as a first debugging check I suggest getting the test suite to pass on your local machine:
...
Starter App is deployable on [Heroku](http://www.heroku.com/). Demo: http://schemer.herokuapp.com/
